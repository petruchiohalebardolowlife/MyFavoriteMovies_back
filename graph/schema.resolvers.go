...
// ID is the resolver for the id field.
func (r *genreResolver) ID(ctx context.Context, obj *structs.Genre) (int32, error) {
	if obj == nil {
    return 0, fmt.Errorf("жанр не найден")
}
return obj.ID, nil
}
...
func (r *queryResolver) GetFavoriteMovies(ctx context.Context, userID int32) ([]*structs.FavoriteMovie, error) {
	panic(fmt.Errorf("not implemented: GetFavoriteMovies - getFavoriteMovies"))
}
